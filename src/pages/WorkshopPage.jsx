...
const WorkshopPage = () => {
  ...
  return (
    <div className="overflow-x-hidden">
      <div className="hero-workshop bg-black relative">
        <motion.div
          className=""
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      >
        <motion.div
          className="flex flex-col sm:flex-row flex-wrap gap-6 sm:gap-10 items-center justify-center"
          variants={containerVariants}
          initial="hidden"
          animate="visible"
        >
          {[
            ...
            <motion.input
              ...
              variants={childVariants}
              whileFocus={{ borderColor: "#D96B1A", scale: 1.02 }}
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
          >
            <span className="relative z-10">Katılım Talebi Oluştur</span>
            <motion.svg
      ...
      >
        <motion.h1
          className="text-[#D96B1A] menu-title text-3xl sm:text-5xl mb-10 sm:mb-20 text-center"
          variants={childVariants}
        >
          CESY CO. WORKSHOP
        </motion.h1>
        ...
        >
          ...
          >
            <motion.h3
              className="text-[#855043] text-2xl sm:text-3xl mb-4"
              variants={childVariants}
            >
              Misyonumuz
            </motion.h3>
            <motion.p
              className="text-style leading-loose text-justify"
              variants={childVariants}
            >
